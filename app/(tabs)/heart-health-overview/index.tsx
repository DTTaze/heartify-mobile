import { BubuCheckInCard } from '@/app/(tabs)/heart-health-overview/components/BubuCheckInCard';
import MedicalRecordDetails from '@/app/(tabs)/heart-health-overview/components/MedicalRecordDetails';
import { NoteCard } from '@/app/(tabs)/heart-health-overview/components/NoteCard';
import ChevronLeftIcon from '@/components/icons/ChevronLeftIcon';
import EditIcon from '@/components/icons/PenIcon';
import { Button } from '@/components/ui/Button';
import { TextCustom } from '@/components/ui/TextCustom';
import { ScrollView, View } from 'react-native';
import HeartRiskIndex from './components/HeartRiskIndex';
import MedicalRecordSection from './components/MedicalRecordSection';

export default function HeartHealthOverview() {
  return (
    <ScrollView className="flex-1 bg-white px-4 pb-24 pt-2">
